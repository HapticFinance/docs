...
- `Technical council` controls the multisig for protocol upgrades. 
- `Treasury council` controls the Treasury multisig.
- `Supervisor council` oversees the DAO general operations.
